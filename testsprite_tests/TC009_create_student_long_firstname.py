"""
TC009: Input Validation - Firstname Too Long
Tests that create_student rejects firstname longer than 100 characters
"""
import requests
...
def test_create_student_long_firstname():
    ...
    try:
        ...
        # Try to create student with firstname > 100 chars
        long_name = "A" * 101
        ...
        print("[PASS] Test passed: Long firstname validation works")
...
test_create_student_long_firstname()
